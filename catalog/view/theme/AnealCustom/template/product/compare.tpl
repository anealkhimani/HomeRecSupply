    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <!-- Price is displayed here.  Replace the price with ** Call for Price ** on items
          that are $0.00.  Rebuild it from scratch, cause dayum-->
          <?php
            echo "<tr>";
              echo "<td>$text_price</td>";
              foreach($products as $product) {
                echo "<td>";
                if($products[$product['product_id']]['price']) {
                  if (!$products[$product['product_id']]['special']) {
                    // check if the price is 0
                    if($products[$product['product_id']]['price'] === "$0.00") {
                      
                      echo "** Call for Price **<br /><b>404-800-7975</b>";
                    }else{
        ...
        <tr>
          ...
          <!-- Buttons are displayed here.  Disable the Add To cart button if the price is 0.00 -->
          <?php
            foreach($products as $product) {
              echo "<td>";
                if($products[$product['product_id']]['price'] === "$0.00") { ?>
