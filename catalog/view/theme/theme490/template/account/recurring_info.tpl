...
<?php echo $column_left; ?>
  ...
  <div class="buttons">
    <div class="right">
        <?php if($cancel_link){ ?>
            <a href="<?php echo $cancel_link; ?>" class="button-cont-right" onclick="return confirmCancel();"><?php echo $button_cancel_profile; ?><i class="fa fa-arrow-circle-right"></i></a>
        <?php } ?>
        <a href="<?php echo $continue; ?>" class="button-cont-right"><?php echo $button_continue; ?><i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
